#ifndef __TTPOD_TT_H264DATA_H
#define __TTPOD_TT_H264DATA_H
...
static const uint8_t golomb_to_pict_type[5] = {
    TTV_PICTURE_TYPE_P, TTV_PICTURE_TYPE_B, TTV_PICTURE_TYPE_I,
    TTV_PICTURE_TYPE_SP, TTV_PICTURE_TYPE_SI
};
