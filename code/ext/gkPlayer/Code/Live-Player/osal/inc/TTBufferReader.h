/**
* File : TTBufferReader.h  
* Created on : 2014-10-21
* Author : yongping.lin
* Description : CTTBufferReader声明文件
*/
#ifndef __TT_BUFFER_READER__H__
#define __TT_BUFFER_READER__H__
...
class CTTBufferReader : public CTTBaseDataReader
{ 
public:
	/**
	* \fn                       CTTBufferReader()
...
private:
	CTTBufferReaderProxy*		iBufferReaderProxy;
};
