...
static const char* const kClassPathName = "com/goku/media/player/GKMediaPlayer";
...
void JNITTMediaPlayerListener::PlayerNotifyEvent(GKNotifyMsg aMsg, TTInt aArg1, TTInt aArg2, const TTChar* aArg3)
{
	CJniEnvUtil	env(gJVM);
	JNIEnv* penv = env.getEnv();
	if (penv)
...
//static void ttpod_media_TTMediaPlayer_native_init(JNIEnv* env)
//{
//}
...
static void SetSurface(JNIEnv* env,jobject obj, MediaPara* pMediaPara)
{
   ...
   {	
	   void* pParam = NULL;
	   if(g_Surface != NULL) {
			pParam = (void *)&g_Surface;
	   }
	   //LOGI("SetSurface pParam %x, g_Surface %x", pParam, g_Surface);
	   pMediaPara->iMediaPlayer->SetView(pParam);
   }
...
static void ttpod_media_TTMediaPlayer_native_setup(JNIEnv* env, jobject thiz, jobject weak_this, jbyteArray signatures, jint samplerate, jstring plugin_path) {
    ...
    IGKMediaPlayer* pMediaPlayer = new CGKMediaPlayer(PlayerListener, pPluginChars);

	pMediaPara->iPlayerListener = PlayerListener;
	pMediaPara->iMediaPlayer = pMediaPlayer;
	//audioTrack_native_init
	jclass AudioTrack = env->FindClass("com/goku/media/player/GKAudioTrack");
	...
	if (strstr (szProp, "2.") == szProp || strstr (szProp, "1.") == szProp) {
		jclass VideoTrack = env->FindClass("com/goku/media/player/GKVideoTrack");
...
static void ttpod_media_TTMediaPlayer_native_release(JNIEnv* env, jobject thiz, jint context)
{
...
static void ttpod_media_TTMediaPlayer_setCacheFilePath_native(JNIEnv* env, jobject thiz, jint context, jstring uri)
{
...
static int ttpod_media_TTMediaPlayer_setDataSourceSync_native(JNIEnv* env, jobject thiz, jint context, jstring uri, jint flag)
{
...
static int ttpod_media_TTMediaPlayer_setDataSourceAsync_native(JNIEnv* env, jobject thiz, jint context, jstring uri, jint flag)
{
	...
	int nErr = -1;
	if (pMediaPara->iMediaPlayer != NULL && uri != NULL)
	{
		const char *uriStr = env->GetStringUTFChars(uri, NULL);
...
static int ttpod_media_TTMediaPlayer_play_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static void ttpod_media_TTMediaPlayer_pause_native(JNIEnv* env, jobject thiz, jint context, jboolean afadeout)
{
...
static void ttpod_media_TTMediaPlayer_resume_native(JNIEnv* env, jobject thiz, jint context, jboolean afadein)
{
...
static void ttpod_media_TTMediaPlayer_setAudioEffectLowDelay_native(JNIEnv* env, jobject thiz, jint context, jboolean lowdelay)
{
	gAudioEffectLowDelay = lowdelay;
}

static void ttpod_media_TTMediaPlayer_setvolume_native(JNIEnv* env, jobject thiz, jint context, jint lvolume, jint rvolume)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_stop_native(JNIEnv* env, jobject thiz, jint context)
{
...
static int ttpod_media_TTMediaPlayer_setSurface_native(JNIEnv* env, jobject thiz, jint context)
{
...
static void ttpod_media_TTMediaPlayer_setPlayRange_native(JNIEnv* env, jobject thiz, jint context, jint start, jint end)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_setPosition_native(JNIEnv* env, jobject thiz, jint context, jint pos, jint flag)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	int nPos = 0;
	if (pMediaPara == NULL)
...
static void ttpod_media_TTMediaPlayer_setActiveNetWorkType_native(JNIEnv* env, jobject thiz, jint context, jint type)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
	...
	if (pMediaPara->iMediaPlayer != NULL)
	{
		pMediaPara->iMediaPlayer->SetActiveNetWorkType((GKActiveNetWorkType)type);
	}
	else
	{
		LOGI("Player Not Existed");
...
static void ttpod_media_TTMediaPlayer_setDecoderType_native(JNIEnv* env, jobject thiz, jint context, jint type)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
	...
	if (pMediaPara->iMediaPlayer != NULL)
	{
		pMediaPara->iMediaPlayer->SetDecoderType((GKDecoderType)type);
	}
	else
	{
		LOGI("Player Not Existed");
...
static int ttpod_media_TTMediaPlayer_getPosition_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_duration_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_size_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_bufferedSize_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_bufferedPercent_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_bufferBandWidth_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_bufferBandPercent_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_getStatus_native(JNIEnv* env, jobject thiz, jint context)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_getCurFreqAndWave_native(JNIEnv* env, jobject thiz, jint context, jshortArray freqarr, jshortArray wavearr, jint samplenum)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
		return -1;
...
static int ttpod_media_TTMediaPlayer_getCurFreq_native(JNIEnv* env, jobject thiz, jint context, jshortArray freqarr, jint freqnum)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static int ttpod_media_TTMediaPlayer_getCurWave_native(JNIEnv* env, jobject thiz, jint context, jshortArray wavearr, jint wavenum)
{
	MediaPara* pMediaPara = (MediaPara* )context;
	if (pMediaPara == NULL)
	{
...
static void ttpod_media_TTMediaPlayer_CongfigProxyServer_native(JNIEnv* env, jobject thiz, jint context, jstring aIP, jint aPort, jstring authenkey, jboolean aUserProxy)
{
...
static void ttpod_media_TTMediaPlayer_setHostMetaData_native(JNIEnv* env, jobject thiz, jstring haddr)
{
	if (haddr == NULL)
		SetHostMetaData(NULL);
	else{
		const char *haddrStr = env->GetStringUTFChars(haddr, NULL);
		SetHostMetaData(haddrStr);
		env->ReleaseStringUTFChars(haddr, haddrStr);
	}
}

static void ttpod_media_TTMediaPlayer_CongfigProxyServerByDomain_native(JNIEnv* env, jobject thiz, jstring aDomain, jint aPort, jstring authenkey, jboolean aUserProxy)
{
	if (aDomain == NULL || authenkey == NULL)
	{
		ConfigProxyServerByDomain(NULL, 0, NULL, ETTFalse);
	}
	else{
		struct in_addr address; 
		const char *pAuthenkey = env->GetStringUTFChars(authenkey, NULL);
		const char *pDomain = env->GetStringUTFChars(aDomain, NULL);
		ConfigProxyServerByDomain(pDomain, aPort, pAuthenkey, aUserProxy);
		env->ReleaseStringUTFChars(authenkey, pAuthenkey);
		env->ReleaseStringUTFChars(aDomain, pDomain);
	} 
}

static void ttpod_media_TTMediaPlayer_setLogOpenSwitch(JNIEnv* env, jobject thiz, jboolean open)
{
	if (open)
		setLogOpenSwitch(LOG_SWITCH_OPEN);
	else
		setLogOpenSwitch(LOG_SWITCH_CLOSE);
}

static JNINativeMethod gMethods[] = {
    //{"nativeInit",         "()V",            					(void *)ttpod_media_TTMediaPlayer_native_init},
    {"nativeSetup",        "(Ljava/lang/Object;[BILjava/lang/String;)V",    			(void *)ttpod_media_TTMediaPlayer_native_setup},
    {"nativeRelease",      "(I)V",            					(void *)ttpod_media_TTMediaPlayer_native_release},
    {"nativePlay",      			"(I)I",       						(void *)ttpod_media_TTMediaPlayer_play_native},
    {"nativeSetDataSourceAsync", 	"(ILjava/lang/String;I)I",    (void *)ttpod_media_TTMediaPlayer_setDataSourceAsync_native},
    {"nativeSetDataSourceSync", 	"(ILjava/lang/String;I)I",    (void *)ttpod_media_TTMediaPlayer_setDataSourceSync_native},
    {"nativeSetCacheFilePath", 	"(ILjava/lang/String;)V",    (void *)ttpod_media_TTMediaPlayer_setCacheFilePath_native},
    {"nativeStop",      	"(I)I",       						(void *)ttpod_media_TTMediaPlayer_stop_native},
    {"nativeSetSurface",      		"(I)I",       				(void *)ttpod_media_TTMediaPlayer_setSurface_native},
	{"nativePause",      			"(IZ)V",       						(void *)ttpod_media_TTMediaPlayer_pause_native},
    {"nativeResume",      		"(IZ)V",       						(void *)ttpod_media_TTMediaPlayer_resume_native},
    {"nativeSetPosition",      	"(III)I",       						(void *)ttpod_media_TTMediaPlayer_setPosition_native},
    {"nativeSetPlayRange",      	"(III)V",       						(void *)ttpod_media_TTMediaPlayer_setPlayRange_native},
    {"nativeGetPosition",      	"(I)I",       						(void *)ttpod_media_TTMediaPlayer_getPosition_native},
    {"nativeSetActiveNetWorkType", "(II)V",       						(void *)ttpod_media_TTMediaPlayer_setActiveNetWorkType_native},
	{"nativeSetDecoderType", "(II)V",       						(void *)ttpod_media_TTMediaPlayer_setDecoderType_native},
    {"nativeDuration",      		"(I)I",       						(void *)ttpod_media_TTMediaPlayer_duration_native},
    {"nativeSize",      		"(I)I",       						(void *)ttpod_media_TTMediaPlayer_size_native},
    {"nativeBufferedSize",      		"(I)I",       						(void *)ttpod_media_TTMediaPlayer_bufferedSize_native},
    {"nativeBufferedPercent",   	"(I)I",       				   		(void *)ttpod_media_TTMediaPlayer_bufferedPercent_native},
	{"nativeBufferBandWidth",   	"(I)I",       				   		(void *)ttpod_media_TTMediaPlayer_bufferBandWidth_native},
    {"nativeGetStatus",      		"(I)I",       						(void *)ttpod_media_TTMediaPlayer_getStatus_native},
    {"nativeGetCurFreqAndWave",   "(I[S[SI)I",       			(void *)ttpod_media_TTMediaPlayer_getCurFreqAndWave_native},
    {"nativeGetCurWave",   		"(I[SI)I",       				(void *)ttpod_media_TTMediaPlayer_getCurWave_native},
    {"nativeGetCurFreq",   		"(I[SI)I",       				(void *)ttpod_media_TTMediaPlayer_getCurFreq_native},
    {"nativeSetVolume",   		"(III)V",       				   	(void *)ttpod_media_TTMediaPlayer_setvolume_native},
    {"nativeSetAudioEffectLowDelay" ,  "(IZ)V",                  (void *)ttpod_media_TTMediaPlayer_setAudioEffectLowDelay_native},
	{"nativeCongfigProxyServer" ,  "(ILjava/lang/String;ILjava/lang/String;Z)V",  (void *)ttpod_media_TTMediaPlayer_CongfigProxyServer_native},
	{"nativeBufferBandPercent",   	"(I)I",       				   		(void *)ttpod_media_TTMediaPlayer_bufferBandPercent_native},
	{"nativeSetHostMetadata", 	"(Ljava/lang/String;)V",    (void *)ttpod_media_TTMediaPlayer_setHostMetaData_native},
	{"nativeCongfigProxyServerByDomain" ,  "(Ljava/lang/String;ILjava/lang/String;Z)V",  (void *)ttpod_media_TTMediaPlayer_CongfigProxyServerByDomain_native},
	{"nativeSetLogOpenSwitch" ,  "(Z)V",                  (void *)ttpod_media_TTMediaPlayer_setLogOpenSwitch},
};
