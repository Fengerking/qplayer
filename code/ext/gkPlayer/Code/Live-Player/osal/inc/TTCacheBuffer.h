/**
* File : TTCacheBuffer.h  
* Created on : 2014-10-22
* Author : yongping.lin
* Description : CTTCacheBuffer
*/
...
public:
	...
	*/
	TTInt							Read(TTUint8* aBuffer, TTInt64 aReadPos, TTInt aReadSize);
	...
	* \return						操作状态
	*/
	TTInt							Write(TTUint8* aBuffer, TTInt64 aWritePos, TTInt aWriteSize);
