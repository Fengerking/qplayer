...
public:
	...
	*/
	...
	TTInt							Decode(const TTChar* aUrl, const TTChar* OutPutPath);

	TTInt							DecodeData(const TTChar* Outputpath);

	TTInt							GetDataFromSpecifiedTimePos(const TTChar* aUrl, TTInt timePos, TTInt duration);

	TTInt							ExtractData(TTInt duration);
