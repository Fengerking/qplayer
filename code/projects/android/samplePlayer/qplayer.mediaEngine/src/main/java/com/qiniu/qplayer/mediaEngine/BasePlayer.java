...
public interface BasePlayer {
	...
	public static final int		QCPLAY_FORMAT_TS			= 4;
	...
	public static final	int 	QCPLAY_PID_AudioTrackNum	= 0X11000007;
	public static final	int 	QCPLAY_PID_AudioTrackPlay	= 0X11000008;
	...
	public static final int	QCPLAY_PID_MP4_PRELOAD				= 0X11000341;
	...
	// The parameter objParam should be String. The output file name
	public static final int	QCPLAY_PID_START_SAVE_FILE			= 0X11000520;
	// Set to stop save output file.
	// The parameter should be 0
	public static final int QCPLAY_PID_STOP_SAVE_FILE			= 0X11000521;
