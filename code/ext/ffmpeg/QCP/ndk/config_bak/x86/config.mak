...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --cc=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi- --nm=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-nm --sysroot=/work/tools/android-ndk-r9d/platforms/android-8/arch-arm --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --enable-shared --disable-static --enable-small --extra-ldflags='-Wl,-rpath-link=/work/tools/android-ndk-r9d/platforms/android-8/arch-arm/usr/lib -L/work/tools/android-ndk-r9d/platforms/android-8/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog' --enable-optimizations --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --disable-postproc --disable-swscale --disable-swresample --disable-encoders --disable-decoders --disable-bsfs --disable-muxers --disable-demuxers --disable-protocols --disable-parsers --disable-debug --enable-decoder=h264 --enable-decoder=hevc --arch=arm --enable-armv5te --enable-armv6 --enable-vfp --enable-neon --enable-neon
...
CC_IDENT=gcc 4.6 (GCC) 20120106 (prerelease)
ARCH=arm
INTRINSICS=neon
CC=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
CXX=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-g++
AS=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
OBJCC=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
LD=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
DEPCC=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-ranlib
STRIP=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/work/tools/android-ndk-r9d/platforms/android-8/arch-arm -isysroot /work/tools/android-ndk-r9d/platforms/android-8/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -I$(SRC_PATH)/compat/atomics/gcc
CFLAGS=  -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-windres
DEPWINDRES=/work/tools/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,-rpath-link=/work/tools/android-ndk-r9d/platforms/android-8/arch-arm/usr/lib -L/work/tools/android-ndk-r9d/platforms/android-8/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog  --sysroot=/work/tools/android-ndk-r9d/platforms/android-8/arch-arm -isysroot /work/tools/android-ndk-r9d/platforms/android-8/arch-arm -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
NOREDZONE_FLAGS=
libavcodec_VERSION=57.81.100
libavcodec_VERSION_MAJOR=57
libavcodec_VERSION_MINOR=81
libavdevice_VERSION=..
...
libavformat_VERSION=57.66.102
libavformat_VERSION_MAJOR=57
libavformat_VERSION_MINOR=66
libavresample_VERSION=3.2.0
libavresample_VERSION_MAJOR=3
libavresample_VERSION_MINOR=2
libavutil_VERSION=55.47.100
libavutil_VERSION_MAJOR=55
libavutil_VERSION_MINOR=47
libpostproc_VERSION=54.2.100
libpostproc_VERSION_MAJOR=54
libpostproc_VERSION_MINOR=2
libswresample_VERSION=2.4.100
libswresample_VERSION_MAJOR=2
libswresample_VERSION_MINOR=4
libswscale_VERSION=4.3.101
