...
//	private String			m_strNextFile5 = "http://musically.muscdn.com/reg02/2017/05/31/02/234148590598897664.mp4";
	...
	private String			m_strNextFile1  = "http://play.youletd.com/v?m=v1&id=346146";
	private String			m_strNextFile2  = "http://play.youletd.com/v?m=v1&id=364439";
	private String			m_strNextFile3  = "http://play.youletd.com/v?m=v1&id=306951";
	private String			m_strNextFile4  = "http://play.youletd.com/v?m=v1&id=347079";
	private String			m_strNextFile5  = "http://play.youletd.com/v?m=v1&id=391500";

	private int				m_nPlayIndex = 2;
...
//				m_Player.Play();
	...
	//	m_Player.SetParam(BasePlayer.QCPLAY_PID_Start_Pos, 10000, null);
	...
	private void OpenNextFile (boolean bSameSource){
    	if (m_Player == null)
    		return;
    	int nFlag = 0;
    	if (bSameSource)
		...
		if (m_nPlayIndex == 0)
			m_Player.Open(m_strNextFile1, nFlag);
		else if (m_nPlayIndex == 1)
			m_Player.Open(m_strNextFile2, nFlag);
		else if (m_nPlayIndex == 2)
			m_Player.Open(m_strNextFile3, nFlag);
		else if (m_nPlayIndex == 3)
			m_Player.Open(m_strNextFile4, nFlag);
		else if (m_nPlayIndex == 4)
			m_Player.Open(m_strNextFile5, nFlag);
		m_nPlayIndex++;
		if (m_nPlayIndex > 4)
			m_nPlayIndex = 0;
	}
	...
	//	m_layButtons.setVisibility(View.INVISIBLE);
		...
		m_btnPlay.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				//m_Player.SetParam (BasePlayer.QCPLAY_PID_Download_Pause, 0, null);
				if (m_Player != null)
					m_Player.Play();
				m_btnPlay.setVisibility(View.INVISIBLE);
				m_btnPause.setVisibility(View.VISIBLE);
		...
		m_btnPause.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				//m_Player.SetParam (BasePlayer.QCPLAY_PID_Download_Pause, 1, null);
				if (m_Player != null)
					m_Player.Pause();
				m_btnPause.setVisibility(View.INVISIBLE);
				m_btnPlay.setVisibility(View.VISIBLE);
