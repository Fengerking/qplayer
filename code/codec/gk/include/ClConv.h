...
* Description : ClConv定义文件
*/

#ifndef __TTCOLORCONV_H__
#define __TTCOLORCONV_H__
...
void	colorConNxN_neon(TTPBYTE pSrc_y, TTPBYTE pSrc_u, TTPBYTE pSrc_v,const TTUint32 inStride,TTPBYTE pOutBuf, const TTUint32 outStride,
											  TTInt32 width, TTInt32 height,const TTInt32 uinStride, const TTInt32 vinStride);
#endif
