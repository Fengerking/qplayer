...
{
public:
	CThreadWork(CBaseInst * pBaseInst);
	...
	virtual int				RemoveEvent(CThreadEvent * pEvent);
	virtual int				ResetEvent(void);
	virtual int				ResetEventByID(int nID);
