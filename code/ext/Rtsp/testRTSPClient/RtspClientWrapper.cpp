...
RTSPSourceCallBack   gFramefcallback = NULL;
...
void SetCallback(RTSPSourceCallBack _callback)
{
	gFramefcallback = _callback;
}
...
struct timeval presentationTime, unsigned /*durationInMicroseconds*/) {
	...
	if (gFramefcallback != NULL)
	{
		gFramefcallback(0, NULL, 0, (char*)fReceiveBuffer, NULL);
	}
