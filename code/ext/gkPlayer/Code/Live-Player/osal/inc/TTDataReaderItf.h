...
class ITTDataReader : public IGKInterface
{
public:
	enum TTDataReaderId
	{
...
public:
	...
	*/
	virtual TTInt				ReadSync(TTUint8* aReadBuffer, TTInt64 aReadPos, TTInt aReadSize) = 0;
	...
	* \return					读取正确时返回实际读取的字节数，否则为错误码
	*/
	virtual TTInt				ReadWait(TTUint8* aReadBuffer, TTInt64 aReadPos, TTInt aReadSize) = 0;
	...
	*/
	virtual TTUint16			ReadUint16(TTInt64 aReadPos) = 0;// 按高字节在后面读
	...
	* \return					返回整数值，超过范围会Assert
	*/
	virtual TTUint16			ReadUint16BE(TTInt64 aReadPos) = 0;// 按高字节在前面读
	...
	* \return					返回整数值，超过范围会Assert
	*/
	virtual TTUint32			ReadUint32(TTInt64 aReadPos) = 0;
	...
	* \return					返回整数值，超过范围会Assert
	*/
	virtual TTUint32			ReadUint32BE(TTInt64 aReadPos) = 0;
	...
	* \return					返回整数值，超过范围会Assert
	*/
	virtual TTUint64			ReadUint64(TTInt64 aReadPos) = 0;
	...
	* \return					返回整数值，超过范围会Assert
	*/
	virtual TTUint64			ReadUint64BE(TTInt64 aReadPos) = 0;
	...
	*/
	...
	virtual TTUint64            BufferedSize() = 0;
     ...
     * \brief
     */
	virtual TTInt               PrepareCache(TTInt64 aReadPos, TTInt aReadSize, TTInt aFlag) = 0;
