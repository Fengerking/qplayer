...
#ifndef GKASSERT
#define GKASSERT(exp)			assert(exp)
#endif
...
#define TTKErrServerStreamEOF		 -65

#define TTKErrServerDataError		 -66

#define TTKErrFormatChanged    			-70

#define TTKErrHandshakeFailed        -71
#define TTKErrSendConnPacketFailed   -72
#define TTKErrDNSFailed				 -73
