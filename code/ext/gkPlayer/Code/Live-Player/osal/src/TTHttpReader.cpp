...
TTInt CTTHttpReader::ReadWait(TTUint8* aReadBuffer, TTInt64 aReadPos, TTInt aReadSize)
{
...
TTUint64 CTTHttpReader::BufferedSize()
{
	GKASSERT(iHttpReaderProxy != NULL);
...
TTInt CTTHttpReader::PrepareCache(TTInt64 aReadPos, TTInt aReadSize, TTInt aFlag)
{
	if (iHttpReaderProxy != NULL)
