/**
* File : TTMediainfoProxy.h 
* Description : CTTMediaInfoProxy定义文件
*/
...
static const TTInt KMaxMediaBufferSize = 1024*4;
...
private:
	...
	static TTBool IsFLV(const TTUint8* aHeader);
    static TTBool IsAIFF(const TTUint8* aHeader);
	...
	static TTBool IdentifyMp3ByBuffer(ITTDataReader& aDataReader);
	static TTBool IdentifyAACByBuffer(ITTDataReader& aDataReader);
