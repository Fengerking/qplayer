#ifndef __TTPOD_TT_H264DSP_H
#define __TTPOD_TT_H264DSP_H
...
typedef struct H264DSPContext {
    ...
    void (*h264_h_loop_filter_luma_intra)(uint8_t *pix, int stride,
                                          int alpha, int beta);
    void (*h264_h_loop_filter_luma_mbatt_intra)(uint8_t *pix /*align 16*/,
    ...
    void (*h264_h_loop_filter_chroma_intra)(uint8_t *pix /*align 8*/,
                                            int stride, int alpha, int beta);
    void (*h264_h_loop_filter_chroma_mbatt_intra)(uint8_t *pix /*align 8*/,
                                                  int stride, int alpha, int beta);
...
void tt_h264dsp_init(H264DSPContext *c, const int bit_depth,
                     const int chroma_format_idc);
void tt_h264dsp_init_aarch64(H264DSPContext *c, const int bit_depth,
                             const int chroma_format_idc);
void tt_h264dsp_init_arm(H264DSPContext *c, const int bit_depth,
                         const int chroma_format_idc);
void tt_h264dsp_init_ppc(H264DSPContext *c, const int bit_depth,
                         const int chroma_format_idc);
void tt_h264dsp_init_x86(H264DSPContext *c, const int bit_depth,
                         const int chroma_format_idc);

#endif /* __TTPOD_TT_H264DSP_H */
