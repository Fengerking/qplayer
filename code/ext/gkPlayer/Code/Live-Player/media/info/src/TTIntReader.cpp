/*
* File : TTIntReader.cppe
* Description : CTTIntReader
*/
...
double CTTIntReader::ReadDouble64(const TTUint8* aReadPtr)
{
	double dVal;
	unsigned char *ci, *co;
...
{
	TTUint32 nSizeHigh  = TTUint32(aReadPtr[0] << 24) | TTUint32(aReadPtr[1] << 16) | TTUint32(aReadPtr[2] << 8) | aReadPtr[3];
	TTUint32 nSizeLow = TTUint32(aReadPtr[4] << 24) | TTUint32(aReadPtr[5] << 16) | TTUint32(aReadPtr[6] << 8) | aReadPtr[7];
