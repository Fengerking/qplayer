/**
* File : TTAudioProcess.h 
* Created on : 2014-9-1
* Author : yongping.lin
* Description : TTAudioProcess定义文件
*/
...
private:
	...
	virtual TTInt							resetAudioEffect();
	...
	virtual TTInt							doAudioEffect(TTBuffer* dstBuffer);
	...
	virtual TTInt							doTDStretchConv(TTBuffer* srcBuffer, TTBuffer* dstBuffer);
