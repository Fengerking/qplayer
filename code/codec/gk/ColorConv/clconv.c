...
void colorConNxN_c(TTPBYTE pSrc_y, TTPBYTE pSrc_u, TTPBYTE pSrc_v,const TTUint32 inStride,TTPBYTE pOutBuf, const TTUint32 outStride,
											  TTInt32 width, TTInt32 height,const TTInt32 uinStride, const TTInt32 vinStride)
{
	TTInt32 i;
...
void colorConNxN_new(TTPBYTE pSrc_y, TTPBYTE pSrc_u, TTPBYTE pSrc_v,const TTUint32 inStride,TTPBYTE pOutBuf, const TTUint32 outStride,
											  TTInt32 width, TTInt32 height,const TTInt32 uinStride, const TTInt32 vinStride)
{
	TTInt32 i;
	TTInt32 b0, b1, b2;
