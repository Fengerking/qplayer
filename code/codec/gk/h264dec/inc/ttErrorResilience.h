#ifndef __TTPOD_TT_ERROR_RESILIENCE_H
#define __TTPOD_TT_ERROR_RESILIENCE_H
...
void tt_er_add_slice(ERContext *s, int startx, int starty, int endx, int endy,
                     int status);

#endif /* __TTPOD_TT_ERROR_RESILIENCE_H */
