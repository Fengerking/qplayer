...
typedef struct tagQCANA_EVT_BASE
{
    ...
    long long	llOpenStartTime;	/*!< open URL time, UTC */
...
// Startup event
typedef struct tagQCANA_EVT_STARTUP : QCANA_EVT_BASE
{
    int nGopTime;				  /*!< GOP time */
    int nConnectTime;        	  /*!< connect server time */
    int nFirstByteTime;        	  /*!< recv first byte time */
    int nFirstAudioRenderTime;    /*!< first audio render time */
    int nFirstVideoRenderTime;    /*!< first video render time */
}QCANA_EVT_STARTUP;
...
// Stop event
typedef struct tagQCANA_EVT_STOP : QCANA_EVT_CLOSE
{
    int	nSystemErrCode;				/*!< OS error code */
    int nFirstFrameRenderTime;		/*!< First frame render time */
}QCANA_EVT_STOP;
